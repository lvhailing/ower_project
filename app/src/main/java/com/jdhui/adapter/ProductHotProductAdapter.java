...
public class ProductHotProductAdapter extends BaseAdapter {
    ...
    public ProductHotProductAdapter(Context context, MouldList<ResultProductIndexHotItemBean> list) {
...
//		Log.e(tag, "list=="+list.size());
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            holder = new Holder();
            convertView = inflater.inflate(R.layout.activity_product_hot_product_item, null);
