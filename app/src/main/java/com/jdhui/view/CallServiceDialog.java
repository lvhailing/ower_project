 ...
 * 拨打电话的弹框
 */
public class CallServiceDialog extends Dialog implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private OnCallServiceChanged onChanged = null;

    public CallServiceDialog(Context context, OnCallServiceChanged onChanged, String info) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View mView = inflater.inflate(R.layout.dialog_call_service, null);
    ...
    public interface OnCallServiceChanged {
