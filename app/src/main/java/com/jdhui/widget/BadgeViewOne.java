...
public class BadgeViewOne extends TextView {

    private boolean mHideOnNull = true;

    public BadgeViewOne(Context context) {
        this(context, null);
    }

    public BadgeViewOne(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    public BadgeViewOne(Context context, AttributeSet attrs, int defStyle) {
