...
public class HtmlLoadUtil {
	 ...
	 * @return
	 */
	public static String findPWDbyPhone(String mobile, String newPassword,
										String userName, String validateCode) {
		FindPWDbyPhoneBean b = new FindPWDbyPhoneBean(mobile, newPassword,
				userName,validateCode);
		return getResult(b);
	}
	/**
	 * 上传头像
...
//		NullBean b = new UserIDBean(userId);
	 ...
	 * @return
	 */
	public static String savePhone(String userId, String mobile,
										String validateCode) {
