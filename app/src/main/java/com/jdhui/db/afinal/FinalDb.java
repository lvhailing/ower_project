...
import com.jdhui.db.afinal.db.sqlite.CursorUtils;
import com.jdhui.db.afinal.db.sqlite.DbModel;
import com.jdhui.db.afinal.db.sqlite.ManyToOneLazyLoader;
import com.jdhui.db.afinal.db.sqlite.OneToManyLazyLoader;
import com.jdhui.db.afinal.db.sqlite.SqlBuilder;
import com.jdhui.db.afinal.db.sqlite.SqlInfo;
import com.jdhui.db.afinal.db.table.KeyValue;
import com.jdhui.db.afinal.db.table.ManyToOne;
import com.jdhui.db.afinal.db.table.OneToMany;
import com.jdhui.db.afinal.db.table.TableInfo;
import com.jdhui.db.afinal.exception.DbException;
...
public class FinalDb {
	 ...
	 * @param entity
	 */
	public void lhlSaveLHL(Object entity) {
//		exeSqlInfo(SqlBuilder.buildInsertSql(entity));
...
//			debugSql(sqlInfo.getSql());
	...
	private <T> List<T> findAllBySql(Class<T> clazz, String strSQL) {
		//吕海岭加 通过多次日志数据表明 该方法会出现nullpoint异常
//		if(strSQL==null||clazz==null)
