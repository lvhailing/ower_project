 ...
 * 更多--产品预约
 */
public class ProductBookingActivity extends BaseActivity implements View.OnClickListener {
...
//        requestData();
    ...
    private void requestData() {
        try {
            ...
            HtmlRequest.getProductOrderList(ProductBookingActivity.this, userInfoId, category, status, currentPage + "", new BaseRequester.OnRequestListener() {
                @Override
                public void onRequestFinished(BaseParams params) {
                    if (params.result == null) {
                        Toast.makeText(ProductBookingActivity.this, "加载失败，请确认网络通畅", Toast.LENGTH_LONG).show();
                    ...
                    if ((everyList == null || everyList.size() == 0) && currentPage != 1) {
                        Toast.makeText(ProductBookingActivity.this, "已经到最后一页", Toast.LENGTH_SHORT).show();
                    }
                    if (currentPage == 1) {
                    ...
                    if (mAdapter == null) {
                        //第一次创建adpter
                        mAdapter = new ProductOrderAdapter(ProductBookingActivity.this, totalList);
