 ...
 * 服务--提交豪华邮轮预约
 */
public class SubBookingShipActivity extends BaseActivity implements View.OnClickListener {
                ...
                if (params != null) {
                    ...
                    if (bookingShip != null) {
                        if (Boolean.parseBoolean(bookingShip.getFlag())) {
                            Toast.makeText(SubBookingShipActivity.this, "预约成功", Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(SubBookingShipActivity.this, MainActivity.class);
                            intent.putExtra("tab", 2);
                            startActivity(intent);
                        } else {
                            Toast.makeText(SubBookingShipActivity.this, "预约失败，请您检查提交信息", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(SubBookingShipActivity.this, "加载失败，请确认网络通畅", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
